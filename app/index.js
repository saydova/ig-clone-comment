...
import { Modal, TouchableHighlight } from "react-native-web";
    ...
    <View style={{ flex: 1, backgroundColor: "white" }}>
      ...
      <ScrollView style={{ flex: 1 }}>
        ...
        <ScrollView horizontal={true} >
          ...
          <View style={{ paddingHorizontal: "20px", paddingBottom: "20px" }}>
        ...
        <View style={{ paddingHorizontal: 20, paddingVertical: 15 }}>
          <View style={{ flexDirection: "row", alignContent: "center", justifyContent: "space-between" }}>
            ...
            <Text style={{ paddingTop: 4, color: "darkcyan" }}>Older posts</Text>
          </View>
        </View>
        ...
        <View>
          ...
          <View style={{
            ...
            <TouchableHighlight onPress={() => setModalVisible(true)} underlayColor="#ddd">
              <Text style={{ color: 'gray' }}>View 12 comment</Text>
            </TouchableHighlight>
            {/* Modal component */}
      ...
      >
        <View style={{ marginTop: 300, width: 480, marginLeft: 3.1, height: 2000, flex: 1 }}>
          <View style={styles.modalContainer}>
              ...
              <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
                <View style={{ flexDirection: "row" }}>
                  <Image
                    ...
                    style={{ width: 40, height: 40, borderWidth: 3, borderRadius: 50, borderColor: "white" }}
                  />
                  <View>
                    <Text style={{ paddingBottom: 2, fontWeight: "bold" }}>VigroJS_69</Text>
                    <Text style={styles.comment}>Sumpah gua ganteng banget</Text>
                  </View>
                </View>
                <AntDesign style={{ paddingTop: 8, paddingRight: 5 }} name="hearto" size={15} color="black" />
              </View>
            ...
            <View style={{ paddingVertical: 5, justifyContent: "flex-end" }}>

                <View style={{ flexDirection: "row", justifyContent:"space-around", fontSize:30, marginBottom:5}}>
                  😍
                  🥰
                  😘
                  😗
                ...
                <View style={{ flexDirection: "row" }}>
                  <Image
                    ...
                    style={{ width: 50, height: 50, borderWidth: 3, borderRadius: 50, borderColor: "white" }}
                  />
                  <TextInput
                    style={{ marginLeft: 5, borderRadius: "15px", borderColor: "gray", borderWidth: "1px", height: 30, width: 300, marginTop: 10, paddingHorizontal: 6, paddingVertical: 2 }}
                    // Update state on text change
                    placeholder="add a comment for VirgoJs_69"
                  />
                </View>
              </View>
